...
'
' ASCOM Switch driver for wittinobiArduinoSwitchASCOMv1wifiDRIVER
'
' Description:	Driver for Arduino ESP8266 (ESP-12e) with 8Channel Relay Switch.
'
...
'
'
' Your driver's ID is ASCOM.wittinobiArduinoSwitchASCOMv1wifiDRIVER.Switch
'
...
<Guid("4cd22ae0-07ea-465d-850f-dc1fd9689040")>
<ClassInterface(ClassInterfaceType.None)>
Public Class Switch

    ' The Guid attribute sets the CLSID for ASCOM.wittinobiArduinoSwitchASCOMv1wifiDRIVER.Switch
    ' The ClassInterface/None attribute prevents an empty interface called
    ' _wittinobiArduinoSwitchASCOMv1wifiDRIVER from being created and used as the [default] interface
    ...
    '
    Friend Shared driverID As String = "ASCOM.wittinobiArduinoSwitchASCOMv1wifiDRIVER.Switch"
    Private Shared driverDescription As String = "wittinobiArduinoSwitchASCOMv1wifiDRIVER Switch"

    Friend Shared comPortProfileName As String = "IP" 'Constants used for Profile persistence
    Friend Shared traceStateProfileName As String = "Trace Level"
    Friend Shared comPortDefault As String = "192.168.220.79"
    ...
    Public Sub New()
        ...
        TL = New TraceLogger("", "wittinobiArduinoSwitchASCOMv1wifiDRIVER")
...
#Region "Common properties and methods"
    ...
    Public Property Connected() As Boolean Implements ISwitchV2.Connected
        ...
        Set(value As Boolean)
            ...
            If value Then
                ...
                httpRequest = HttpWebRequest.Create("http://" + comPort.ToString() + "/?MAXSWITCH=" + numSwitch.ToString())
    ...
    Public ReadOnly Property Name As String Implements ISwitchV2.Name
        Get
            Dim s_name As String = "wittinobiArduinoSwitchASCOMv1wifiDRIVER"
        ...
        If state = False Then
            ...
            Using driverProfile As New Profile()
                ...
                If id = 0 And CShort(numSwitch) >= 1 Then
                    ...
                    id = id + 1
                    Dim httpRequest As HttpWebRequest
                    httpRequest = HttpWebRequest.Create("http://" + comPort.ToString() + "/?RELAY" + id.ToString() + "=OFF")
                    Dim httpResponse As HttpWebResponse
                    httpResponse = httpRequest.GetResponse()
                    Using reader As New System.IO.StreamReader(httpResponse.GetResponseStream())
                        reader.ReadToEnd()
        ...
        ElseIf state = True Then
            ...
            Using driverProfile As New Profile()
                ...
                If id = 0 And CShort(numSwitch) >= 1 Then
                    ...
                    id = id + 1
                    Dim httpRequest As HttpWebRequest
                    httpRequest = HttpWebRequest.Create("http://" + comPort.ToString() + "/?RELAY" + id.ToString() + "=ON")
                    Dim httpResponse As HttpWebResponse
                    httpResponse = httpRequest.GetResponse()
                    Using reader As New System.IO.StreamReader(httpResponse.GetResponseStream())
                        reader.ReadToEnd()
